...
| Glama directory | Existing repository listing | [Already indexed](https://glama.ai/mcp/servers/Prem5123/BookMCP), verified September 8; no duplicate submission. |
| TensorBlock/awesome-mcp-servers | One Knowledge Management & Memory entry | [PR #2233](https://github.com/TensorBlock/awesome-mcp-servers/pull/2233) submitted September 8; editorial review pending. |
| abordage/awesome-mcp | One RAG repository entry | [PR #109](https://github.com/abordage/awesome-mcp/pull/109) submitted September 8; editorial review pending. |
