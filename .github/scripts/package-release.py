...
shutil.copytree("docs", staging / "docs", dirs_exist_ok=True, ignore=shutil.ignore_patterns("superpowers"))
...
archive = Path(shutil.make_archive(str(Path("dist") / name), archive_format, "dist", name))
